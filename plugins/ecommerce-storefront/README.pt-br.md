...
1.**storefront-best-practices**

- Orientações completas para a construção de storefronts de e-commerce (componentes, layouts, funcionalidades, integração com backend)
