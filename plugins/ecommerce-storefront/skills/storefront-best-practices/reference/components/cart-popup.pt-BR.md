...
**IMPORTANTE: Sempre exiba detalhes da variação (tamanho, cor, material, etc.) no popup do carrinho, e não apenas os títulos dos produtos.**
...
**IMPORTANTE: Sempre mostre detalhes da variação (tamanho, cor, material, etc.) para cada item no carrinho.**

Sem detalhes da variação, os usuários não conseguem confirmar se adicionaram a variação correta. Isso é especialmente crítico quando os produtos têm várias opções.
...
- Reverta as atualizações otimistas em caso de falha

**Animações:** Transições suaves (250-350ms), slide-in drawer, fade-in/out de fundo. Destaque os itens recém-adicionados.
