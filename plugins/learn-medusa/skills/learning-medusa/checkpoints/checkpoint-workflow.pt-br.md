...
**Saída esperada**: A compilação deve ser bem-sucedida. O TypeScript não deve apresentar erros relacionados ao workflow.

## Problemas comuns

### “Função assíncrona não permitida no workflow”
...
Assim que esse ponto de verificação for aprovado:
