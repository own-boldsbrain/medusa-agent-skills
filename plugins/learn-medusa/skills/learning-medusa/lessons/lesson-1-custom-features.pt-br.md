...
Sim! Adicione-os dentro do corpo da classe. Mas, para operações CRUD básicas, os métodos gerados já são suficientes.
...
## Ponto de verificação 1.3: Teste a rota da API
