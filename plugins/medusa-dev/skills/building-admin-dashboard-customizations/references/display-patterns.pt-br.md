...
- [Padrão DataTable](#padrao-datatable)
  - [Implementação completa do DataTable](#implementacao-completa-do-datatable)
  - [Solução de problemas do DataTable](#solucao-de-problemas-com-o-datatable)
- [Padrões de lista simples](#padroes-simples-de-lista)
  - [Item de lista de produtos/variantes](#item-de-lista-de-produtovariante)
  - [Lista de texto simples (sem miniaturas)](#lista-simples-de-texto-sem-miniaturas)
  - [Lista compacta (sem cartões)](#lista-compacta-sem-cartoes)
  - [Exibição em grade](#exibicao-em-grade)
