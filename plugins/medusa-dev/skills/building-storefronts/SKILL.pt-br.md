...
- Usar o React Query para busca de dados
...
- Opções de configuração específicas da estrutura
...
1. **Back-end (skill “building-with-medusa”):** Módulo → Fluxo de trabalho → Rota da API
2. **Storefront (esta skill):** SDK → React Query → Componentes da interface do usuário
3. **Conexão:**
