...
- [Como usar fluxos de trabalho em rotas de API](#usando-fluxos-de-trabalho-em-rotas-de-api)
...
**⚠️ CRÍTICO - Padrão de exportação de middlewares:**
...
## Usando fluxos de trabalho em rotas de API
...
### Padrão: Consulta manual (quando não é necessária uma configuração de consulta)
