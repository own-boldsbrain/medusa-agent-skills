...
- [Etapa 1: Definição de um link](#passo-1-definindo-um-link)
...
- **Vínculos entre módulos diferentes** (por exemplo, Produto → Marca): Use `query.index()` para filtrar ✅
