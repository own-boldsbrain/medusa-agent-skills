...
- ✅ Recuperar dados **dentro de um único módulo** (produtos com variantes — no mesmo módulo)
...
- Realizar consultas do outro lado não fizer sentido
...
Quando as entidades estão vinculadas por meio de [links de módulo](module-links.md), você tem duas opções, dependendo de suas necessidades de filtragem:
