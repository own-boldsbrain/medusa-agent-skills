...
## Token FinOps
- **Tokens se retraduzir tudo**: 253026
- **Tokens após triagem (High-Token P0)**: 167137
- **Tokens economizados (Zero-Token P1/P2)**: 85889
...
| english_residual_detected | 17 | 17 |
...
- **Score: 100** | `SKILL.pt-br.md` 
  ...
  - Issues: heading_count_mismatch, code_block_mismatch, markdown_violations
- **Score: 100** | `connecting-to-backend.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: conversational_filler_detected, english_residual_detected, heading_count_mismatch, markdown_violations, code_block_mismatch, toc_anchor_mismatch
- **Score: 100** | `design.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: english_residual_detected, heading_count_mismatch, markdown_violations, code_block_mismatch, toc_anchor_mismatch
...
- **Score: 100** | `breadcrumbs.pt-br.md` 
  - Ação: `repair_by_script`
  - Issues: low_line_ratio, list_count_drop, markdown_violations
...
- **Score: 100** | `popups.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: toc_anchor_mismatch, heading_count_mismatch, code_block_mismatch
...
- **Score: 100** | `product-slider.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: toc_anchor_mismatch, heading_count_mismatch, code_block_mismatch, english_residual_detected
...
- **Score: 100** | `static-pages.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: english_residual_detected, heading_count_mismatch, list_count_drop, markdown_violations, low_line_ratio, code_block_mismatch, toc_anchor_mismatch
- **Score: 100** | `SKILL.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: list_count_drop, heading_count_mismatch, code_block_mismatch, markdown_violations
- **Score: 100** | `SKILL.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: heading_count_mismatch, code_block_mismatch, markdown_violations
- **Score: 100** | `SKILL.pt-br.md` 
