...
## Token FinOps
- **Tokens se retraduzir tudo**: 232681
- **Tokens após triagem (High-Token P0)**: 184103
- **Tokens economizados (Zero-Token P1/P2)**: 48578

## Ocorrências (Por Arquivo vs Frequência Absoluta)
| Problema | Arquivos Afetados | Total de Ocorrências |
|---|---|---|
| markdown_violations | 40 | 40 |
| code_block_mismatch | 38 | 38 |
...
- **Score: 100** | `connecting-to-backend.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, code_block_mismatch, heading_count_mismatch, english_residual_detected, conversational_filler_detected, toc_anchor_mismatch
- **Score: 100** | `design.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, code_block_mismatch, heading_count_mismatch, english_residual_detected, toc_anchor_mismatch
...
- **Score: 100** | `breadcrumbs.pt-br.md` 
  - Ação: `repair_by_script`
  - Issues: markdown_violations, list_count_drop, low_line_ratio
...
- **Score: 100** | `product-slider.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: code_block_mismatch, heading_count_mismatch, english_residual_detected, toc_anchor_mismatch
...
- **Score: 100** | `home-page.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: list_count_drop, truncated_target, heading_count_mismatch
- **Score: 100** | `order-confirmation.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: list_count_drop, code_block_mismatch, truncated_target, heading_count_mismatch
...
- **Score: 100** | `static-pages.pt-br.md` 
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, code_block_mismatch, list_count_drop, heading_count_mismatch, low_line_ratio, english_residual_detected, toc_anchor_mismatch
