...
export const FROZEN_LEGACY_PATHS = new Set([
  ...
  "plugins/design-log/skills/design-log-read/SKILL.pt-BR.md",
  "plugins/ecommerce-storefront/README.pt-BR.md",
  "plugins/ecommerce-storefront/skills/storefront-best-practices/SKILL.pt-BR.md",
  "plugins/ecommerce-storefront/skills/storefront-best-practices/reference/components/breadcrumbs.pt-BR.md",
  "plugins/ecommerce-storefront/skills/storefront-development/SKILL.pt-BR.md",
  "plugins/ecommerce-storefront/skills/storefront-nextjs-starter/SKILL.pt-BR.md",
  ...
  "plugins/medusa-dev/skills/accessing-documentation/SKILL.pt-BR.md",
  "plugins/medusa-dev/skills/adding-custom-api-routes/SKILL.pt-BR.md",
  ...
  "plugins/medusa-dev/skills/creating-commerce-modules/SKILL.pt-BR.md",
  "plugins/medusa-dev/skills/creating-data-models/SKILL.pt-BR.md",
