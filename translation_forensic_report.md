...
- **Score: 100** | `connecting-to-backend.pt-br.md`
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, toc_anchor_mismatch, english_residual_detected, code_block_mismatch, heading_count_mismatch, conversational_filler_detected
- **Score: 100** | `design.pt-br.md`
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, toc_anchor_mismatch, english_residual_detected, code_block_mismatch, heading_count_mismatch
...
- **Score: 100** | `product-slider.pt-br.md`
  - Ação: `retranslate_from_source`
  - Issues: toc_anchor_mismatch, english_residual_detected, code_block_mismatch, heading_count_mismatch
...
- **Score: 100** | `static-pages.pt-br.md`
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, toc_anchor_mismatch, english_residual_detected, low_line_ratio, list_count_drop, code_block_mismatch, heading_count_mismatch
- **Score: 100** | `SKILL.pt-br.md`
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, list_count_drop, code_block_mismatch, heading_count_mismatch
- **Score: 100** | `SKILL.pt-br.md`
  - Ação: `retranslate_from_source`
  - Issues: markdown_violations, code_block_mismatch, heading_count_mismatch
- **Score: 100** | `SKILL.pt-br.md`
